...
export class CityService {
  ...
  getAll(): Observable<CityDepartamentModel[]>{
    return this.http.get<CityDepartamentModel[]>('/api/city', {headers:{Authorization: 'Bearer ' + this.storageService.getCurrentSession().token}})
  }
}
